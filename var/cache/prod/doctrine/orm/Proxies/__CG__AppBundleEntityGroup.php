...
class Group extends \AppBundle\Entity\Group implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Group' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Group' . "\0" . 'teacher_id', '' . "\0" . 'AppBundle\\Entity\\Group' . "\0" . 'group_name', '' . "\0" . 'AppBundle\\Entity\\Group' . "\0" . 'league_name', '' . "\0" . 'AppBundle\\Entity\\Group' . "\0" . 'feedback', '' . "\0" . 'AppBundle\\Entity\\Group' . "\0" . 'assets', '' . "\0" . 'AppBundle\\Entity\\Group' . "\0" . 'virtual_money', '' . "\0" . 'AppBundle\\Entity\\Group' . "\0" . 'start_date', '' . "\0" . 'AppBundle\\Entity\\Group' . "\0" . 'end_date', '' . "\0" . 'AppBundle\\Entity\\Group' . "\0" . 'created_by', '' . "\0" . 'AppBundle\\Entity\\Group' . "\0" . 'created_at', '' . "\0" . 'AppBundle\\Entity\\Group' . "\0" . 'updated_by', '' . "\0" . 'AppBundle\\Entity\\Group' . "\0" . 'updated_at'];
        }
