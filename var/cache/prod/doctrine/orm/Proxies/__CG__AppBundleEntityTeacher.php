 ...
 */
class Teacher extends \AppBundle\Entity\Teacher implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Teacher' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Teacher' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Teacher' . "\0" . 'surname', '' . "\0" . 'AppBundle\\Entity\\Teacher' . "\0" . 'email', '' . "\0" . 'AppBundle\\Entity\\Teacher' . "\0" . 'password', '' . "\0" . 'AppBundle\\Entity\\Teacher' . "\0" . 'university', '' . "\0" . 'AppBundle\\Entity\\Teacher' . "\0" . 'created_by'];
        }
